...
$ cargo build --release
$ cargo test
$ ./target/release/omni example model.omni
...
- **Zero dependencies.** `docs/design/sdk.md` §5 claims a conforming C0 reader
  ...
  the evidence rather than the assertion — SHA-256, CRC-32C and a strict
...
- §03.5 SHA-256 digests, content addressing, deduplication

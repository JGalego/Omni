...
A minimal 1-tensor container (`examples/minimal.omni`, produced by the reference
implementation):

```
000000  89 4f 4d 4e 49 0d 0a 1a  01 00 00 00 01 0c 80 00   |.OMNI...........|
        └─ magic ──────────────┘  maj   min  bo al  hsz
000010  01 8f 3d 5c 7a 21 74 e2  9c 33 10 5b 4a 6f 1d 88   |  file_uuid      |
000020  1e 00 20 00 0b 00 00 00  80 00 00 00 00 00 00 00   |algo prof dlen…  |
        alg prf dl rs  flags        front_sb_off = 0x80
000030  00 04 00 00 00 00 00 00  00 30 00 00 00 00 00 00   | len=1024  size  |
000040  7c c1 4b 91 3e 2a … (32 bytes root_digest)
000060  6f 6d 6e 69 2d 72 73 2f  31 2e 30 2e 30 00 00 00   |omni-rs/1.0.0...|
000070  00 00 00 00 00 00 00 00  00 00 00 00 5a 3b 91 e4   |  created   crc |
000080  4f 53 45 47 04 00 02 00  …                          |OSEG kind=SUPER |
…
001000  4f 53 45 47 01 00 01 00  …                          |OSEG kind=BLOB  |
002000  <tensor payload, 4096-aligned, mmap-ready>
…
```

See [`examples/`](../../examples) for the full annotated dump and the CBOR
diagnostic rendering of each object.

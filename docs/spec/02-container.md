...
00000030  51 01 00 00 00 00 00 00  c0 bc 01 00 00 00 00 00  |Q...............|
          └ front_sb_len = 337 ─┘  └─ file_size = 113856 ──┘
...
00000050  c5 36 40 ff a6 f5 52 03  5c 8f 71 f0 3b 80 1d 46  |.6@...R.\.q.;..F|
          └─ root_digest: sha256 of the Manifest object ─────────────────┘
...
0x00000080  SUPER      337 B   front superblock
...
0x0001ac80  SUPER      337 B   back superblock, byte-identical to the front
0x0001bd80  (trailer)   64 B
```

`flags = 0x03` is `SEALED | FRONT_SB`. `front_sb_off = 0xa0` = `0x80 + 32`, the
superblock segment's header plus its 32-byte frame.

...
is no `mount` and no `by-novelty` partitioning. The signature stack of §12.5 is implemented (Ed25519 and ES256,
COSE_Sign1, trust policies) and has had no third-party review; ML-DSA is not,
and a container signed with one is reported indeterminate by name. The distribution
